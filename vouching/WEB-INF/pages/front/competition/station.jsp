				...
				<table width="100%" border="0" cellspacing="1" cellpadding="0">
					...
					<tr>
						<td height="120" align="center" valign="middle">
							<table border="0" cellspacing="1" cellpadding="0" class="hdbg">
								<tr><td colspan="3" class="hdtitle">小组1</td></tr>
								<tr>
									<td class="hdstat"><input type="button" value="user01"/></td>
									<td class="hdstat"><input type="button" value="user02"/></td>
									<td class="hdstat"><input type="button" value="user03"/></td>
								</tr>
								<tr>
									<td class="hdstat"><input type="button" value="user04"/></td>
									<td class="hdstat"><input type="button" value="user05"/></td>
									<td class="hdstat"><input type="button" value="user06"/></td>
								</tr>
							</table>
						</td>
						<td height="120" align="center" valign="middle">
