...
<body style="background-color:#f2f9fd;">
	...
	<div class="leftnav">
		...
		<ul style="display:block">
			...
			<li><a href="#" target="right"><span class="icon-caret-right"></span>教师管理</a></li>
		...
		<ul style="display:block">
			<li><a href="#" target="right"><span class="icon-caret-right"></span>章节管理</a></li>
			<li><a href="#" target="right"><span class="icon-caret-right"></span>词汇管理</a></li>
